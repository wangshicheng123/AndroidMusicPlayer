/*
 * @Author: your name
 * @Date: 2021-04-22 15:18:34
 * @LastEditTime: 2021-04-22 15:20:19
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /MusicProject/src/components/DiagnoseDialog/index.tsx
 */
...
const DiagnoseDialog = ({ visible, hideDialog }: DiagnoseDialogProps) => {
  return (
    <Portal>
